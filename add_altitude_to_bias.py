...
save_dir = "D:\Developer\water_ml\Data\Bias_and_Alt\\{}\\{}_{}.csv"
...
for season in seasons:
    ...
    for i in range(23):
        ...
        merged_data = pd.merge(season_data,altitude_data, on = "site", how = "inner")


        merged_data = merged_data[merged_data["Altitude"].notna()]
        merged_data = merged_data[merged_data["bias"].notna()]

        merged_data.to_csv(save_dir.format(season, season.lower(),i + starting_year), index=False)